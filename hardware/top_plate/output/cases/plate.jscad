function leftcutout_extrude_1_2_outline_fn(){
    return new CSG.Path2D([[92,-159.5],[150,-159.5]]).appendArc([152,-161.5],{"radius":2,"clockwise":true,"large":false}).appendPoint([152,-168.5]).appendArc([154,-170.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([170.9208076,-170.5]).appendPoint([192.6781879,-177.5694013]).appendPoint([208.5326208,-185.9993528]).appendArc([211.2374591,-185.1724009],{"radius":2,"clockwise":false,"large":false}).appendPoint([219.3593171,-169.8974074]).appendPoint([199.670009,-159.4284166]).appendPoint([199.7275809,-159.2512284]).appendPoint([198.7226969,-158.9247218]).appendPoint([198.1685749,-158.6300899]).appendPoint([198.1166233,-158.7277966]).appendPoint([183.381966,-153.9402162]).appendArc([182,-152.0381032],{"radius":2,"clockwise":true,"large":false}).appendPoint([182,-75.5]).appendArc([180,-73.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([92,-73.5]).appendArc([90,-75.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([90,-104.5]).appendArc([88,-106.5],{"radius":2,"clockwise":true,"large":false}).appendPoint([74,-106.5]).appendArc([72,-108.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([72,-140.5]).appendArc([74,-142.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([88,-142.5]).appendArc([90,-144.5],{"radius":2,"clockwise":true,"large":false}).appendPoint([90,-157.5]).appendArc([92,-159.5],{"radius":2,"clockwise":false,"large":false}).close().innerToCAG()
.subtract(
