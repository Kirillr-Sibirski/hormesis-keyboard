function leftcutout_extrude_1_2_outline_fn(){
    return new CSG.Path2D([[89,-159.5],[150,-159.5]]).appendArc([152,-161.5],{"radius":2,"clockwise":true,"large":false}).appendPoint([152,-168.5]).appendArc([154,-170.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([170.9208076,-170.5]).appendPoint([192.6781879,-177.5694013]).appendPoint([208.5326208,-185.9993528]).appendArc([211.2374591,-185.1724009],{"radius":2,"clockwise":false,"large":false}).appendPoint([219.6879472,-169.2793441]).appendArc([218.8609953,-166.5745058],{"radius":2,"clockwise":false,"large":false}).appendPoint([200.517226,-156.8209507]).appendPoint([200.5619268,-156.6833758]).appendPoint([199.7817007,-156.429865]).appendPoint([199.4361481,-156.2461314]).appendPoint([199.4037509,-156.3070616]).appendPoint([183.381966,-151.1012682]).appendArc([182,-149.1991552],{"radius":2,"clockwise":true,"large":false}).appendPoint([182,-75.5]).appendArc([180,-73.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([71,-73.5]).appendArc([69,-75.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([69,-140.5]).appendArc([71,-142.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([85,-142.5]).appendArc([87,-144.5],{"radius":2,"clockwise":true,"large":false}).appendPoint([87,-157.5]).appendArc([89,-159.5],{"radius":2,"clockwise":false,"large":false}).close().innerToCAG()
.subtract(
